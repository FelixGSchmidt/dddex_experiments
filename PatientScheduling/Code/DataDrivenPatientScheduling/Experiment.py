...
from .PatientScheduling import PatientScheduling
...
class Experiment:
    ...
    def run(self, X, y, date, dates, areas, rooms, weightsModel = None, 
        ...
        # SAA by area
            ...
            weightsModel_ = copy.deepcopy(weightsModel)
            weightsModel = {}
            ...
            for area in list(set(areas_test)):
                ...
                # Fit copy of SAA
                weightsModel[area] = copy.deepcopy(weightsModel_)
                weightsModel[area].fit(y_train[area == areas_train])
        ...
        for room in list(set(rooms_test)):
            ...
            if isinstance(weightsModel, dict):
                ...
                for area in list(set(areas_test_)):
                    ...
                    conditionalDistributions[area] = weightsModel[area].getWeights(outputType='summarized')
